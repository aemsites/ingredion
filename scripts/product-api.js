...
export const DEFAULT_PATHS = {
  POPULATE_INGREDIENT_CATEGORY_SUBCATEGORY: (region, locale) => `/${region}/${locale}/jcr:content/header.search.json`,
  ...
  INGREDIENT_SEARCH_TYPEAHEAD: (region, locale) => `/${region}/${locale}.ingredient-search-typeahead.json`,
